...
__inline static void   disable_edge_ioapic_irq(unsigned int irq ) 
{ 
...
__inline static void   eth_copy_and_sum(struct sk_buff *dest ,
...
__inline static int   inet_ifa_match(u32 addr ,
                                                                       struct in_ifaddr *ifa ) 
{ 

  {
  return ((int   )(! ((addr ^ ifa->ifa_address) &
                                                        ifa->ifa_mask) != 0));
}
}
__inline static int   bad_mask(u32 mask , u32 addr ) 
{ __u32 __x ;
  __u32   tmp ;
...
{ struct in_device *in_dev ;
  ...
  return ((struct in_device   *)in_dev);
}
}
__inline static struct in_device   *__in_dev_get(struct net_device  const  *dev ) 
{ 

  {
  return ((struct in_device   *)((struct in_device *)dev->ip_ptr));
}
}
...
__inline static __u32   inet_make_mask(int logmask ) 
{ __u32 __x ;
  __u32   tmp ;
...
__inline static int   inet_mask_len(__u32 mask ) 
{ __u32 __x ;
  __u32   tmp ;
  unsigned long   tmp___0 ;
...
__inline static void   proc_device_tree_add_node(struct device_node *np ,
                                                                                   struct proc_dir_entry *pde ) 
{ 
...
{ struct proc_dir_entry *res ;
  ...
  return ((struct proc_dir_entry   *)res);
}
}
__inline static struct proc_dir_entry   *create_proc_info_entry(char const   *name ,
                                                                                                  mode_t mode ,
                                                                                                  struct proc_dir_entry *base ,
                                                                                                  get_info_t *get_info ) 
{ struct proc_dir_entry *res ;
...
__inline static struct proc_dir_entry   *proc_net_create(char const   *name ,
                                                                                           mode_t mode ,
                                                                                           get_info_t *get_info ) 
{ struct proc_dir_entry   *tmp ;
...
__inline static struct proc_dir_entry   *proc_net_fops_create(char const   *name ,
                                                                                                mode_t mode ,
...
__inline static void   proc_net_remove(char const   *name ) 
{ 
...
__inline static void   kclist_add(struct kcore_list *new ,
...
{ struct inode  const  *__mptr ;
  ...
  {
  __mptr = inode;
  return ((struct proc_inode   *)((struct proc_inode *)((char *)__mptr -
...
{ struct proc_inode   *tmp ;
  ...
  {
  tmp = PROC_I(inode);
  return ((struct proc_dir_entry   *)tmp->pde);
}
}
...
__inline static int   parport_yield(struct pardevice *dev ) 
...
{ unsigned long timeslip ;
  ...
  parport_release(dev);
  tmp = (int   )parport_claim_or_block(dev);
  return (tmp);
}
}
...
__inline static void   parport_generic_irq(int irq ,
                                                                             struct parport *port ,
                                                                             struct pt_regs *regs ) 
{ 
...
__inline static void   __neigh_parms_put(struct neigh_parms *parms ) 
{ 
...
__inline static void   neigh_parms_put(struct neigh_parms *parms ) 
{ int   tmp ;
...
__inline static struct neigh_parms   *neigh_parms_clone(struct neigh_parms *parms ) 
{ 

  {
  atomic_inc(& parms->refcnt);
  return ((struct neigh_parms   *)parms);
}
}
...
__inline static struct neighbour   *neigh_clone(struct neighbour *neigh ) 
{ 
...
__inline static void   neigh_confirm(struct neighbour *neigh ) 
{ 
...
__inline static int   neigh_is_connected(struct neighbour *neigh ) 
{ 

  {
  return ((int   )((int )neigh->nud_state & 194));
}
}
__inline static int   neigh_is_valid(struct neighbour *neigh ) 
{ 

  {
  return ((int   )((int )neigh->nud_state & 222));
}
}
__inline static int   neigh_event_send(struct neighbour *neigh ,
                                                                         struct sk_buff *skb ) 
{ int   tmp ;
  ...
  if (! ((int )neigh->nud_state & 218)) {
    tmp = (int   )__neigh_event_send(neigh, skb);
    return (tmp);
  }
  return ((int   )0);
}
}
__inline static struct neighbour   *__neigh_lookup(struct neigh_table *tbl ,
                                                                                     void const   *pkey ,
                                                                                     struct net_device *dev ,
                                                                                     int creat ) 
{ struct neighbour *n ;
  ...
  return ((struct neighbour   *)tmp___1);
}
}
__inline static struct neighbour   *__neigh_lookup_errno(struct neigh_table *tbl ,
                                                                                           void const   *pkey ,
                                                                                           struct net_device *dev ) 
{ struct neighbour *n ;
  struct neighbour *tmp ;
  struct neighbour   *tmp___0 ;
  ...
  tmp___0 = (struct neighbour   *)neigh_create(tbl,
                                                                                 pkey,
                                                                                 dev);
  return (tmp___0);
}
...
__inline static void   write_data(struct net_device *dev ,
                                                                    unsigned char data ) 
{ struct parport *port ;
...
{ struct parport *port ;
  ...
  {
  port = (((struct net_local *)dev->priv)->pardev)->port;
  tmp = (unsigned char   )((*((port->ops)->read_status)))(port);
  return (tmp);
}
}
...
__inline static int   plip_receive(unsigned short nibble_timeout ,
                                                                     struct net_device *dev ,
...
__inline static int   plip_send(unsigned short nibble_timeout ,
                                                                  struct net_device *dev ,
                                                                  enum plip_nibble_state *ns_p ,
                                                                  unsigned char data ) 
{ unsigned char c0 ;
...
__inline static int   *__check_timid(void) 
{ 
...
__inline static int   plip_searchfor(int *list ,
                                                                       int a ) 
{ int i ;
...
__inline  static __u64__swab64p___0(__u64 const   *x ) 
{ __u64 tmp ;
...
__inline  static __u64__be64_to_cpup___0(__be64 const   *p ) 
{ __u64 tmp ;
...
{ struct task_struct *tmp ;
  struct task_struct *tmp___234 ;

  {
  tmp___234 = get_current();
  if (tmp___234->cap_effective & (unsigned int )(1 << cap)) {
    tmp = get_current();
